<?php 
    ...
    date_default_timezone_set('America/Mexico_City'); //set datetime
    ...
    if(isset($_POST['btnPost']) && (!empty($_POST['titulo']) || !empty($_POST['contenido'])))
    {
        ...
        if($_FILES['archivo']['size'][0] != 0) //la primera celda
        {
            ...
            if($countfiles <= 5)
            {
                ...
                $post2 = insertPost($conn,$title,$content,$date1,$userData,$cadena); //con files
                if(!$post2){
                    echo "Algo salio mal :(";
                }
            }
        ...
        {
            $post2 = insertPost($conn,$title,$content,$date1,$userData," "); //no file
            if(!$post2){
                echo "Algo salio mal :(";
            }
        }
...
<body>
    <nav class="navbar navbar-dark bg-dark text-light border-bottom">
        <div class="container">
            <img src="../assets/teacher1.jpg" width="60" height="60" class="align-top rounded" alt="">
            <h2>Inicio</h2>
        </div>    
    </nav>
        ...
        <div class="row">
            ...
            <div id="leftbar" class="col-md-4"> <!--LADO IZQUIERDO-->   
                ...
                <div class="row text-center">   
                    ...
                    <div class="col border-start mt-3 d-flex align-items-center justify-content-center">                    
                        <form action="">    
                            <button class="btn btn-secondary" type="submit" formaction="admin_post.php"> 
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mt-2 text-end"> <!--BOTONES-->
                                ...
                                <label class="btn btn-outline-secondary">
                                    ...
                                    <input id="fichero" name="archivo[]" type="file" multiple/>
                                </label>
            ...
            <div id="rightbar" class="col-md-8 text-light rounded">
                ...
                <div class="row admin-col-2 p-2 d-grid gap-2">
