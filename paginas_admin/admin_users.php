<?php
    ...
    $queryPost = "SELECT IDUSUARIO,NOMBRE,MATRICULA,RESPUESTAS FROM USUARIO WHERE tipo = 0";              
    ...
    if(isset($_POST['clean'])){ 
        $delm = mysqli_query($conn,"DELETE FROM USUARIO");
        if(!$delm){
            echo "ALGO SALIO MAL"; 
        }
    }
    ...
    //alter
    $query2 = "SELECT NOMBRE,MATRICULA,RESPUESTAS FROM USUARIO WHERE tipo = 0";              
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-light bg-dark border-end-2">
                ...
                <div class="row list-group p-1">
                    ...
                    <a href="#" class="list-group-item list-group-item-action active">Ver Usuarios</a>
                ...
                <div class="row list-group p-3 d-grid gap-3">
                    ...
                    <form action="" method="post">
                        ...
                        <button class="btn btn-danger" name="clean" type="submit">
                            <i class="bi bi-trash"></i> Limpiar Grupo
                        </button>
                    </form>
